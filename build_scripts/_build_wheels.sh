...
sed -i "s|name='mysqlcipher-binary'|name=PACKAGE_NAME|g" setup.py
...
sed -i "s|name=PACKAGE_NAME,|name='mysqlcipher-binary',|g" setup.py

"${PY36}/pip" wheel /io/mysqlcipher -w /io/wheelhouse
"${PY37}/pip" wheel /io/mysqlcipher -w /io/wheelhouse
"${PY38}/pip" wheel /io/mysqlcipher -w /io/wheelhouse
"${PY39}/pip" wheel /io/mysqlcipher -w /io/wheelhouse
"${PY310}/pip" wheel /io/mysqlcipher -w /io/wheelhouse
"${PY311}/pip" wheel /io/mysqlcipher -w /io/wheelhouse
